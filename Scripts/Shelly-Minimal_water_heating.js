...
let interval = 1 * 60 * 1000; // How often run this script? First number is the minutes. Minutes * 60 sec * 1000 millisec
...
// Check the API response and change the relay accordingly 
